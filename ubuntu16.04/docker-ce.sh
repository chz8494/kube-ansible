...
scp apt-docker-ce k8s-4:/etc/apt/preferences.d/
scp apt-docker-ce k8s-5:/etc/apt/preferences.d/
...
ssh k8s-4 "sh /home/ubuntu/add-repo-docker.sh"
ssh k8s-5 "sh /home/ubuntu/add-repo-docker.sh"
...
ssh k8s-4 "curl -fsSL https://download.docker.com/linux/ubuntu/gpg | sudo apt-key add -"
ssh k8s-5 "curl -fsSL https://download.docker.com/linux/ubuntu/gpg | sudo apt-key add -"
...
ssh k8s-4 "apt-get update && apt-get install docker-ce -y"
ssh k8s-5 "apt-get update && apt-get install docker-ce -y"
